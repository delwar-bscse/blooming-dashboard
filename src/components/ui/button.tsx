  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        paginationButton: "bg-[#D9DAD4] hover:bg-[#828D97] text-white shadow-xs rounded-full cursor-pointer transition-colors duration-300",
        paginationButtonActive: "bg-[#828D97] text-white shadow-xs rounded-full cursor-pointer transition-colors duration-300",
        ...
        customOutlineRed: "bg-transparent text-red-800 hover:text-red-700 text-base cursor-pointer border-2 border-red-800 hover:border-red-600 rounded-md",
        customGreen: "bg-green-800 text-gray-50 hover:text-gray-100 shadow-xs hover:bg-green-700 text-base cursor-pointer shadow-sm",
      },
      size: {
